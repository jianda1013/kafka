...
consumer = KafkaConsumer('godjj',client_id= 'client3', group_id= 'group-python3', bootstrap_servers= ['localhost:9092'])
    ...
    try:
        ...
        if msg:
            ...
            for i in range(len(msg)):
                ...
                #plt.axis("off")
                #plt.margins(x=0, y=0)
                #plt.savefig("../flask_livereload/app/static/godjj_WC.png")
                cloud.to_file("../flask_livereload/app/static/godjj_WC.png")
    except:
        print("1111")
